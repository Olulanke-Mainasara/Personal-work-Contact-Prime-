    ...
    if action == "a":
        ...
        if whichact == "a":
            ...
            if whiche == "a":
                ...
                mobilenumbook.append(("Mobile.no: " + ncontacttelm))
                newcontact.append("Mobile.no: " + ncontacttelm)
                ncontacttelh = (input("Home.no : "))
                homenumbook.append(("Home.no: " + ncontacttelh))
                newcontact.append("Home.no: " + ncontacttelh)
                ncontacttelw = (input("Work.no: "))
                worknumbook.append(("Work.no: " + ncontacttelw))
                newcontact.append("Work.no: " + ncontacttelw)
                print(mobilenumbook)
                print(homenumbook)
                print(worknumbook)
                email1.append(newcontact)
                print("The contact has been saved on the email")
                if newcontact in contactstorage or ncontacttelm in mobilenumbook:
                    print("\n")
